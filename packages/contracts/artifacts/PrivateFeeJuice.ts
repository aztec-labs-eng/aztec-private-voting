...
import PrivateFeeJuiceContractArtifactJson from '../target/private_fee_juice-PrivateFeeJuice.json' with { type: 'json' };
export const PrivateFeeJuiceContractArtifact = loadContractArtifact(PrivateFeeJuiceContractArtifactJson as NoirCompiledContract);



/**
 * Type-safe interface for contract PrivateFeeJuice;
 */
export class PrivateFeeJuiceContract extends ContractBase {
  
  private constructor(
    address: AztecAddress,
    wallet: Wallet,
  ) {
    super(address, PrivateFeeJuiceContractArtifact, wallet);
  }
  ...
  public static at(
    ...
    return Contract.at(address, PrivateFeeJuiceContract.artifact, wallet) as PrivateFeeJuiceContract;
  }
  ...
  public static deploy(wallet: Wallet, instantiation?: DeployInstantiationOptions) {
    return DeployMethod.create<PrivateFeeJuiceContract>(
      wallet,
      {
        artifact: PrivateFeeJuiceContractArtifact,
        postDeployCtor: (instance, wallet) => PrivateFeeJuiceContract.at(instance.address, wallet),
        args: [],
      },
      instantiation,
    );
   ...
   */
  public static deployWithOpts<M extends keyof PrivateFeeJuiceContract['methods']>(
    opts: { method?: M; wallet: Wallet; instantiation?: DeployInstantiationOptions },
    ...args: Parameters<PrivateFeeJuiceContract['methods'][M]>
  ) {
    return DeployMethod.create<PrivateFeeJuiceContract>(
      opts.wallet,
      {
  ...
  public static get artifact(): ContractArtifact {
    return PrivateFeeJuiceContractArtifact;
  }
  ...
  public static get artifactForPublic(): ContractArtifact {
    return loadContractArtifactForPublic(PrivateFeeJuiceContractArtifactJson as NoirCompiledContract);
  }
  ...
  public declare methods: {
    ...
    /** fee_entrypoint() */
    fee_entrypoint: (() => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;

    /** fee_entrypoint_with_topup(amount: integer, secret: field, message_leaf_index: field) */
    fee_entrypoint_with_topup: ((amount: (bigint | number), secret: FieldLike, message_leaf_index: FieldLike) => ContractFunctionInteraction) & Pick<ContractMethod, 'selector'>;
